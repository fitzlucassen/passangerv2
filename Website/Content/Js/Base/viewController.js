...
View.prototype.createCase = function(wording){
	...
	html += '<div class="emptyCase caseFull" style="width:' + this.width + 'px;height:' + this.height + 'px;"><h1>' + wording + '</h1></div>';
    else
	html += '<div class="emptyCase caseFull" style="width:' + this.width + 'px;height:' + this.height + 'px;"><h2>' + wording + '</h2></div>';
